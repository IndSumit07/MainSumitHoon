...
const LeetCodeGraph = ({ username }) => {
  ...
  const processData = (submissionCalendar) => {
    ...
    Object.keys(submissionCalendar).forEach((timestamp) => {
      ...
      dateToCountMap[dateStr] =
        (dateToCountMap[dateStr] || 0) + submissionCalendar[timestamp];
      ...
      {hoveredDay && (
        ...
        >
          <div className="font-semibold">
            ...
            {hoveredDay.contributionCount === 1 ? "submission" : "submissions"}
          </div>
